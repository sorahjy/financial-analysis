...
STOCK_SMALLCAP_OPTIMIZED_CONFIG_FILE = DATA_DIR / "stock_strategy_smallcap_optimized_config.json"
STOCK_SMALLCAP_OPTIMIZED_CONFIG_BACKUP_FILE = META_DATA_BACKUP_DIR / "stock_strategy_smallcap_optimized_config.json"
...
class AppConfig:
    ...
    STOCK_SMALLCAP_OPTIMIZED_CONFIG_FILE = STOCK_SMALLCAP_OPTIMIZED_CONFIG_FILE
    STOCK_SMALLCAP_OPTIMIZED_CONFIG_BACKUP_FILE = STOCK_SMALLCAP_OPTIMIZED_CONFIG_BACKUP_FILE
